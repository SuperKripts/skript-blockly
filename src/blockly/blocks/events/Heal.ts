...
import { createFieldDropdown, HealReasons } from '../types/Types'
...
export function register(): Blockly.utils.toolbox.BlockInfo {
  ...
  CodeGenerator.forBlock[blockKey] = (block: Blockly.Block, generate: SkriptCodeGenerator) => {
    ...
    const code = SkriptCodeGenerator.codeJoin('on heal', ['of', entity], ['by', reason], generateCodeForEventPriority(block))
    return `${code}: \n${statementMembers}`
  }
