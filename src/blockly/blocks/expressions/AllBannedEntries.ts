...
const blockKey = 'expression_all_banned_entries'
...
export function register(): Blockly.utils.toolbox.BlockInfo {
  ...
  const mixin: Partial<SkriptBlockDefinition> = {
    initShape_() {
      ...
      pte('EXPRESSION_ALL_BANNED_ENTRIES_DESC', {
        0: () => this.appendDummyInput().appendField(createTempFieldDropdown('expression_all_banned_entries_type', BANNED_TYPES, validator), 'type'),
